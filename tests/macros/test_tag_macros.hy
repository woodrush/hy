...
(defn test_tag_macro_error [] 
 ...
 (try 
 [(try [(macroexpand (get (tokenize "(dispatch_tag_macro '- '())") 0) (HyASTCompiler __name__))] (except [e Py2HyReturnException] (raise e)) (except [e HyTypeError] (assert (in "with the character `-`" (str e)))))] 
