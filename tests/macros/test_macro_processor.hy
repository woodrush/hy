...
(defn test_preprocessor_expression [] 
 ...
 (setv obj (macroexpand (get (tokenize "(test (test \"one\" \"two\"))") 0) (HyASTCompiler __name__))) 
 (assert (= (type obj) HyList)) 
 (assert (= (type (get obj 0)) HyExpression)) 
 (assert (= (get obj 0) (HyExpression [(HySymbol "test") (HyString "one") (HyString "two")]))) 
 (setv obj (HyList [(HyString "one") (HyString "two")])) 
 (setv obj (get (get (tokenize "(shill [\"one\" \"two\"])") 0) 1)) 
