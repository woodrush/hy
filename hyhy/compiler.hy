...
(defclass HyASTCompiler [object] (defn __init__ [self module_name] 
 ...
 (if (isinstance entry HySymbol) (do (__import__ entry) (hyhy.macros.require entry self.module_name :all_macros True :prefix entry)) (do (if (and (isinstance entry HyList) (= (len entry) 2)) (do (do (setv _py2hy_anon_var_G_1250 entry) (do (setv module (nth _py2hy_anon_var_G_1250 0)) (setv names (nth _py2hy_anon_var_G_1250 1)))) (when (not (isinstance names HyList)) (do (raise (HyTypeError names "(require) name lists should be HyLists")))) (__import__ module) (if (in "*" names) (do (when (!= (len names) 1) (do (raise (HyTypeError names "* in a (require) name list must be on its own")))) (hyhy.macros.require module self.module_name :all_macros True)) (do (do (setv assignments {})) (while names (if (and (> (len names) 1) (= (get names 1) (HyKeyword ":as"))) (do (do (setv _py2hy_anon_var_G_1251 (get names (slice None 3 None))) (do (setv k (nth _py2hy_anon_var_G_1251 0)) (do) (setv v (nth _py2hy_anon_var_G_1251 2)))) (del (get names (slice None 3 None))) (do (assoc assignments k v))) (do (do (setv symbol (names.pop 0))) (do (assoc assignments symbol symbol))))) (hyhy.macros.require module self.module_name :assignments assignments)))) (do (if (and (isinstance entry HyList) (= (len entry) 3) (= (get entry 1) (HyKeyword ":as"))) (do (do (setv _py2hy_anon_var_G_1249 entry) (do (setv module (nth _py2hy_anon_var_G_1249 0)) (do) (setv prefix (nth _py2hy_anon_var_G_1249 2)))) (__import__ module) (hyhy.macros.require module self.module_name :all_macros True :prefix prefix)) (do (raise (HyTypeError entry "unrecognized (require) syntax"))))))))) 
 (raise (Py2HyReturnException (Result)))) (except [e Py2HyReturnException] e.retvalue)))) 
 (with_decorator 
