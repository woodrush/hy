...
(defn ast_str [foobar] 
 ...
 (do (setv _py2hy_anon_var_G_1235 (enc foobar)) (do (setv foobar (nth _py2hy_anon_var_G_1235 0)) (do))) 
...
(defclass HyASTCompiler [object] (defn __init__ [self module_name] 
 ...
 (defaults.append ret.force_expr))))) (do (if (= lambda_keyword "&optional") (do (if (isinstance expr HyList) (do (when (not (= (len expr) 2)) (do (raise (HyTypeError expr "optional args should be bare names or 2-item lists")))) (do (setv _py2hy_anon_var_G_1237 expr) (do (setv k (nth _py2hy_anon_var_G_1237 0)) (setv v (nth _py2hy_anon_var_G_1237 1))))) (do (do (setv k expr)) (do (setv v ((. (HySymbol "None") replace) k))))) (when (not (isinstance k HyString)) (do (raise (HyTypeError expr "Only strings can be used as parameter names")))) (args.append k) (setv ret (+ ret (self.compile v))) (defaults.append ret.force_expr)) (do (if (= lambda_keyword "&kwonly") (do (when (not PY3) (do (raise (HyTypeError expr "keyword-only arguments are only available under Python 3")))) (if (isinstance expr HyList) (do (when (!= (len expr) 2) (do (raise (HyTypeError expr "keyword-only args should be bare names or 2-item lists")))) (do (setv _py2hy_anon_var_G_1236 expr) (do (setv k (nth _py2hy_anon_var_G_1236 0)) (setv v (nth _py2hy_anon_var_G_1236 1)))) (kwonlyargs.append k) (setv ret (+ ret (self.compile v))) (kwonlydefaults.append ret.force_expr)) (do (do (setv k expr)) (kwonlyargs.append k) (kwonlydefaults.append None)))) (do (when (= lambda_keyword "&kwargs") (do (when kwargs (do (raise (HyTypeError expr "There can only be one &kwargs argument")))) 
 (do (setv kwargs expr))))))))))))))) 
 ...
 (do (setv _py2hy_anon_var_G_1240 (self._render_quoted_form x level)) (do (setv f_imports (nth _py2hy_anon_var_G_1240 0)) (setv f_contents (nth _py2hy_anon_var_G_1240 1)) (setv splice (nth _py2hy_anon_var_G_1240 2)))) 
 ...
 (contents.append to_add)) (raise (Py2HyReturnException (, imports ((. (HyExpression [(HySymbol name) contents]) replace) form) False)))) (do (if (isinstance form HyCons) (do (do (setv ret (HyExpression [(HySymbol name)]))) (do (setv _py2hy_anon_var_G_1238 (self._render_quoted_form form.car level)) (do (setv nimport (nth _py2hy_anon_var_G_1238 0)) (setv contents (nth _py2hy_anon_var_G_1238 1)) (setv splice (nth _py2hy_anon_var_G_1238 2)))) (when splice (do (raise (HyTypeError form "Can't splice dotted lists yet")))) (imports.update nimport) (ret.append contents) (do (setv _py2hy_anon_var_G_1239 (self._render_quoted_form form.cdr level)) (do (setv nimport (nth _py2hy_anon_var_G_1239 0)) (setv contents (nth _py2hy_anon_var_G_1239 1)) (setv splice (nth _py2hy_anon_var_G_1239 2)))) (when splice (do (raise (HyTypeError form "Can't splice the cdr of a cons")))) (imports.update nimport) (ret.append contents) (raise (Py2HyReturnException (, imports (ret.replace form) False)))) (do (when (isinstance form HySymbol) (do (raise (Py2HyReturnException (, imports ((. (HyExpression [(HySymbol name) (HyString form)]) replace) form) False))))))))) 
 ...
 (do (setv _py2hy_anon_var_G_1241 (self._render_quoted_form (get entries 1) level)) (do (setv imports (nth _py2hy_anon_var_G_1241 0)) (setv stmts (nth _py2hy_anon_var_G_1241 1)) (setv splice (nth _py2hy_anon_var_G_1241 2)))) 
 ...
 (if (isinstance exceptions_list list) (do (if (len exceptions_list) (do (do (setv _py2hy_anon_var_G_1242 (self._compile_collect exceptions_list)) (do (setv elts (nth _py2hy_anon_var_G_1242 0)) (setv _type (nth _py2hy_anon_var_G_1242 1)) (do))) (setv _type (+ _type (ast.Tuple :elts elts :lineno expr.start_line :col_offset expr.start_column :ctx (ast.Load))))) (do (do (setv _type (Result)))))) (do (if (isinstance exceptions_list HySymbol) (do (do (setv _type (self.compile exceptions_list)))) (do (raise (HyTypeError exceptions (% "`%s' needs a valid exception list" catch))))))) 
 ...
 (do (setv orel (Result))) 
 (do (setv _py2hy_anon_var_G_1243 False) (setv nested _py2hy_anon_var_G_1243) (setv root _py2hy_anon_var_G_1243)) 
 ...
 (do (setv _py2hy_anon_var_G_1244 (self._compile_collect expr)) (do (setv slices (nth _py2hy_anon_var_G_1244 0)) (setv ret (nth _py2hy_anon_var_G_1244 1)) (do))) 
 ...
 (do (setv _py2hy_anon_var_G_1245 (self._compile_collect expr)) (do (setv decorators (nth _py2hy_anon_var_G_1245 0)) (setv ret (nth _py2hy_anon_var_G_1245 1)) (do))) 
 ...
 "Using a hacky implementation of `return`" 
 (try (do (expr.pop 0) 
 (do (setv _py2hy_anon_var_G_1246 (self._compile_collect expr)) (do (setv elts (nth _py2hy_anon_var_G_1246 0)) (setv ret (nth _py2hy_anon_var_G_1246 1)) (do))) 
 ...
 (do (setv _py2hy_anon_var_G_1247 (self._compile_generator_iterables expr)) (do (setv gen_res (nth _py2hy_anon_var_G_1247 0)) (setv gen (nth _py2hy_anon_var_G_1247 1)))) 
 ...
 (do (setv _py2hy_anon_var_G_1248 (self._compile_generator_iterables expr)) (do (setv gen_res (nth _py2hy_anon_var_G_1248 0)) (setv gen (nth _py2hy_anon_var_G_1248 1)))) 
 ...
 (if (isinstance entry HySymbol) (do (__import__ entry) (hyhy.macros.require_hyhy entry self.module_name :all_macros True :prefix entry)) (do (if (and (isinstance entry HyList) (= (len entry) 2)) (do (do (setv _py2hy_anon_var_G_1250 entry) (do (setv module (nth _py2hy_anon_var_G_1250 0)) (setv names (nth _py2hy_anon_var_G_1250 1)))) (when (not (isinstance names HyList)) (do (raise (HyTypeError names "(require) name lists should be HyLists")))) (__import__ module) (if (in "*" names) (do (when (!= (len names) 1) (do (raise (HyTypeError names "* in a (require) name list must be on its own")))) (hyhy.macros.require_hyhy module self.module_name :all_macros True)) (do (do (setv assignments {})) (while names (if (and (> (len names) 1) (= (get names 1) (HyKeyword ":as"))) (do (do (setv _py2hy_anon_var_G_1251 (get names (slice None 3 None))) (do (setv k (nth _py2hy_anon_var_G_1251 0)) (do) (setv v (nth _py2hy_anon_var_G_1251 2)))) (del (get names (slice None 3 None))) (do (assoc assignments k v))) (do (do (setv symbol (names.pop 0))) (do (assoc assignments symbol symbol))))) (hyhy.macros.require_hyhy module self.module_name :assignments assignments)))) (do (if (and (isinstance entry HyList) (= (len entry) 3) (= (get entry 1) (HyKeyword ":as"))) (do (do (setv _py2hy_anon_var_G_1249 entry) (do (setv module (nth _py2hy_anon_var_G_1249 0)) (do) (setv prefix (nth _py2hy_anon_var_G_1249 2)))) (__import__ module) (hyhy.macros.require_hyhy module self.module_name :all_macros True :prefix prefix)) (do (raise (HyTypeError entry "unrecognized (require) syntax"))))))))) 
 (raise (Py2HyReturnException (Result)))) (except [e Py2HyReturnException] e.retvalue)))) 
 (with_decorator 
 ...
 (do (setv operator (expression.pop 0))) 
 (do (setv _py2hy_anon_var_G_1252 (get ops operator)) (do (setv opnode (nth _py2hy_anon_var_G_1252 0)) (setv default (nth _py2hy_anon_var_G_1252 1)))) 
 (do (setv _py2hy_anon_var_G_1253 (, operator.start_line operator.start_column)) (do (setv root_line (nth _py2hy_anon_var_G_1253 0)) (setv root_column (nth _py2hy_anon_var_G_1253 1)))) 
 ...
 "Using a hacky implementation of `return`" 
 (try (do (if (is node None) (do (do (setv _py2hy_anon_var_G_1255 (, root_line root_column)) (do (setv line (nth _py2hy_anon_var_G_1255 0)) (setv column (nth _py2hy_anon_var_G_1255 1))))) (do (do (setv _py2hy_anon_var_G_1254 (, node.lineno node.col_offset)) (do (setv line (nth _py2hy_anon_var_G_1254 0)) (setv column (nth _py2hy_anon_var_G_1254 1)))))) 
 ...
 (do (setv _py2hy_anon_var_G_1256 (self._compile_collect expression)) (do (setv exprs (nth _py2hy_anon_var_G_1256 0)) (setv ret (nth _py2hy_anon_var_G_1256 1)) (do))) 
 ...
 (do (setv _py2hy_anon_var_G_1257 (, expression.start_line expression.start_column)) (do (setv lineno (nth _py2hy_anon_var_G_1257 0)) (setv col_offset (nth _py2hy_anon_var_G_1257 1)))) 
 ...
 (when right_associative (do (do (setv _py2hy_anon_var_G_1258 (, right_expr left_expr)) (do (setv left_expr (nth _py2hy_anon_var_G_1258 0)) (setv right_expr (nth _py2hy_anon_var_G_1258 1)))))) 
 ...
 (do (setv _py2hy_anon_var_G_1259 (self._compile_collect (get expression (slice 1 None None)) with_kwargs :oldpy_unpack True)) (do (setv args (nth _py2hy_anon_var_G_1259 0)) (setv ret (nth _py2hy_anon_var_G_1259 1)) (setv keywords (nth _py2hy_anon_var_G_1259 2)) (setv oldpy_starargs (nth _py2hy_anon_var_G_1259 3)) (setv oldpy_kwargs (nth _py2hy_anon_var_G_1259 4)))) 
 ...
 (try (do (do (setv _py2hy_anon_var_G_1260 args) (do (setv target_name (nth _py2hy_anon_var_G_1260 0)) (setv iterable (nth _py2hy_anon_var_G_1260 1))))) (except [e Py2HyReturnException] (raise e)) (except [ValueError] (raise (HyTypeError expression "for requires two forms in the list")))) 
 ...
 "Using a hacky implementation of `return`" 
 (try (do (do (setv _py2hy_anon_var_G_1261 (self._compile_collect expression)) (do (setv elts (nth _py2hy_anon_var_G_1261 0)) (setv ret (nth _py2hy_anon_var_G_1261 1)) (do))) 
 ...
 "Using a hacky implementation of `return`" 
 (try (do (do (setv _py2hy_anon_var_G_1262 (self._compile_collect expression)) (do (setv elts (nth _py2hy_anon_var_G_1262 0)) (setv ret (nth _py2hy_anon_var_G_1262 1)) (do))) 
 ...
 (do (setv _py2hy_anon_var_G_1263 (self._parse_lambda_list arglist)) (do (setv ret (nth _py2hy_anon_var_G_1263 0)) (setv args (nth _py2hy_anon_var_G_1263 1)) (setv defaults (nth _py2hy_anon_var_G_1263 2)) (setv stararg (nth _py2hy_anon_var_G_1263 3)) (setv kwonlyargs (nth _py2hy_anon_var_G_1263 4)) (setv kwonlydefaults (nth _py2hy_anon_var_G_1263 5)) (setv kwargs (nth _py2hy_anon_var_G_1263 6)))) 
 (for [[i arg] (enumerate args)] 
 (when (isinstance arg HyList) (do (when (not arg) (do (raise (HyTypeError arglist "Cannot destruct empty list")))) 
 (do (setv _py2hy_anon_var_G_1264 (HySymbol (self.get_anon_var))) (assoc args i _py2hy_anon_var_G_1264) (setv var _py2hy_anon_var_G_1264)) 
 ...
 (while (> (len pairs) 0) (do (setv _py2hy_anon_var_G_1265 (, (pairs.pop 0) (pairs.pop 0))) (do (setv k (nth _py2hy_anon_var_G_1265 0)) (setv v (nth _py2hy_anon_var_G_1265 1)))) (when (= k (HySymbol "__init__")) (do (v.append (HySymbol "None")))) (new_args.append k) (new_args.append v)) 
 ...
 (if expressions (do (do (setv base_list (expressions.pop 0))) (when (not (isinstance base_list HyList)) (do (raise (HyTypeError expressions "Bases class must be a list")))) (do (setv _py2hy_anon_var_G_1266 (self._compile_collect base_list)) (do (setv bases_expr (nth _py2hy_anon_var_G_1266 0)) (setv bases (nth _py2hy_anon_var_G_1266 1)) (do)))) (do (do (setv bases_expr [])) (do (setv bases (Result))))) 
 (do (setv body (Result))) 
 ...
 "Using a hacky implementation of `return`" 
 (try (do (when (in "." symbol) (do (do (setv _py2hy_anon_var_G_1267 (symbol.rsplit "." 1)) (do (setv glob (nth _py2hy_anon_var_G_1267 0)) (setv local (nth _py2hy_anon_var_G_1267 1)))) 
 ...
 "Using a hacky implementation of `return`" 
 (try (do (do (setv _py2hy_anon_var_G_1268 (self._compile_collect m :dict_display True)) (do (setv keyvalues (nth _py2hy_anon_var_G_1268 0)) (setv ret (nth _py2hy_anon_var_G_1268 1)) (do))) 
