...
(defn run_module [mod_name] 
 (try 
 (do 
 (import [hyhy.importer [MetaImporter]]) 
...
(defn cmdline_handler [scriptname argv] 
 (try 
 (do 
 (setv parser (argparse.ArgumentParser :prog "hyhy" :usage USAGE :formatter_class argparse.RawDescriptionHelpFormatter :epilog EPILOG)) 
...
(defn hyc_main [] 
 (try 
 (do 
 (import [hyhy.importer [write_hy_as_pyc]]) 
